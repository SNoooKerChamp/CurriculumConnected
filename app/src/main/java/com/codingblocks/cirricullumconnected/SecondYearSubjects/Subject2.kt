...
import kotlinx.android.synthetic.main.activity_subject2.*

class Subject2 : AppCompatActivity() {
    var teacherlist = arrayOf("Dr Samsher Gautam", "Mr N Ansari", "Dr PV Ram Kumar")
    var averagelist = arrayOf("0.0", "0.0", "0.0")
    var fragmentmanager: FragmentManager? = null


    override fun onBackPressed() {
        startActivity(Intent(this@Subject2,YearTabbedActivity::class.java))
        super.onBackPressed()
    }
    ...
    inner class Adapter : BaseAdapter() {
        ...
        override fun getView(position: Int, convertview: View?, parent: ViewGroup): View {
            ...
            Glide.with(this@Subject2).load("http://kbfacilitators.com.au/wp-content/uploads/2016/03/PDF-Logo.png")
                    .into(ibpdf)
            ...
            tvratetheapp?.setOnClickListener {
                ...
                fragmenttransaction?.add(R.id.Container2, Ratingfragment.newInstance(teacherlist.get(position), "Thermal Engg II(ME 202)"))?.commit()
            ...
            ibpdf?.setOnClickListener {
                when (position) {
                    0 -> {
                        ...
                        val i1 = Intent(this@Subject2, SingleSubjectnotes::class.java)
                        i1.putExtra("pdf", "http://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf")
                        startActivity(i1)
                    }
                    1 -> {
                        val i2 = Intent(this@Subject2, SingleSubjectnotes::class.java)
                        i2.putExtra("pdf", "http://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf")
                        startActivity(i2)
                    }
                    2 -> {
                        val i3 = Intent(this@Subject2, SingleSubjectnotes::class.java)
            ...
            teachername?.setOnClickListener {
                when (position) {
                    0 -> {
                        val i1 = Intent(this@Subject2, teacherprofile::class.java)
                        i1.putExtra("url", "http://www.dtu.ac.in/Web/Departments/Mechanical/faculty/samsher.php")
                        startActivity(i1)
                    }
                    1 -> Toast.makeText(this@Subject2, "Information currently unavailable", Toast.LENGTH_LONG).show()

                    2 -> {
                        val i2 = Intent(this@Subject2, teacherprofile::class.java)
                        i2.putExtra("url", "http://www.dtu.ac.in/Web/Departments/Mechanical/faculty/pvramkumar.php")
                        startActivity(i2)
                    }
                }
            }
