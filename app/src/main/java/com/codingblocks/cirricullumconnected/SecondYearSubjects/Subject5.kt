...
class Subject5 : AppCompatActivity() {
    ...
    var teacherlist = arrayOf("Dr Ds Nagesh", "Ms Navriti Gupta", "Dr MS Niranjan")
    ...
    inner class Adapter : BaseAdapter() {
        ...
        override fun getView(position: Int, convertview: View?, parent: ViewGroup): View? {
            ...
            Glide.with(this@Subject5).load("http://kbfacilitators.com.au/wp-content/uploads/2016/03/PDF-Logo.png")
                    .into(ibpdf)
            ...
            tvratetheapp?.setOnClickListener {
                ...
                fragmenttransaction?.add(R.id.Container5, Ratingfragment.newInstance(teacherlist.get(position), "Manufacturing Technology I(ME 208)"))?.commit()
            ...
            ibpdf?.setOnClickListener {
                when (position) {
                    0 -> {
                        val i1 = Intent(this@Subject5, SingleSubjectnotes::class.java)
                        i1.putExtra("pdf", "http://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf")
                        startActivity(i1)
                    }
                    1 -> {
                        val i2 = Intent(this@Subject5, SingleSubjectnotes::class.java)
                        i2.putExtra("pdf", "http://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf")
                        startActivity(i2)
                    }
                    2 -> {
                        val i3 = Intent(this@Subject5, SingleSubjectnotes::class.java)
            ...
            teachername?.setOnClickListener {
                when (position) {
                    0 -> Toast.makeText(this@Subject5, "Information currently unavailable", Toast.LENGTH_LONG).show()
                    1 -> {
                        val i1 = Intent(this@Subject5, teacherprofile::class.java)
                        i1.putExtra("url", "http://www.dtu.ac.in/Web/Departments/Mechanical/faculty/navritigupta.php")
                        startActivity(i1)
                    }

                    2 -> {
                        val i2 = Intent(this@Subject5, teacherprofile::class.java)
                        i2.putExtra("url", "http://www.dtu.ac.in/Web/Departments/Mechanical/faculty/msniranjan.php")
                        startActivity(i2)
                    }
                }
            }
